...
namespace KittenFactory.DatabaseMigrator.Migrations
{
    ...
    partial class KittensFactoryContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("KittenFactory.Api.Features.Kittens.Entities.Kitten", b =>
                {
                    ...
                    b.Property<string>("DesignedById")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("designed_by_id");
                    ...
                    b.HasIndex("DesignedById")
                        .HasDatabaseName("ix_kittens_designed_by_id");
            ...
            modelBuilder.Entity("KittenFactory.Api.Features.Kittens.Entities.Kitten", b =>
                {
                    b.HasOne("KittenFactory.Api.Features.Users.Entities.User", "DesignedBy")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_kittens_users_designed_by_id");
